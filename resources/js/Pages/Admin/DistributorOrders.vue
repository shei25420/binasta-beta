        ...
        <div class="card">
            ...
            <div class="card-body">
                <DataTable id="dt" class="display table table-responsive" :options="{responsive: true}" :data="orders" :columns="[
                    {data: 'distributor', render: data => data.first_name + ' ' + data.last_name},
                    {data: null, render: data => data.distributor_address ? data.distributor_address.location : data.location},
                    {data: null, render: data => data.distributor_address ? data.distributor_address.phone_number : data.phone_number},
