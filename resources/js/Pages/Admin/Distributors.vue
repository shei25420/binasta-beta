...
<template>
    <GenericLayout>
        <div class="card">
            ...
            <div class="card-body">
                <DataTable id="dt" :options="{responsive: true}" class="display table table-responsive" :data="distributors" :columns="[
                    { data: 'ref' },
                    { data: 'first_name' },
                    { data: 'last_name' },
                    { data: 'email' },
            ...
            <form @submit.prevent="storeDistributor">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <div class="invalid-feedback" v-if="form.errors.parent_distributor_id">{{ form.errors.parent_distributor_id }}</div>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col">
